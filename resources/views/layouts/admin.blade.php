...
{{--    <link href="{{asset('css/app.css')}}" rel="stylesheet">--}}
    ...
    <link  href="{{asset('css/libs/blog-post.css')}}" rel="stylesheet" type="text/css">
    <link  href="{{asset('css/libs/font-awesome.css')}}" rel="stylesheet" type="text/css">
    <link  href="{{asset('css/libs/metisMenu.css')}}" rel="stylesheet" type="text/css">
    <link  href="{{asset('css/libs/sb-admin-2.css')}}" rel="stylesheet" type="text/css">
    <link  href="{{asset('css/libs/styles.css')}}" rel="stylesheet" type="text/css">
